...
if platform.system() == 'Darwin': gae_path = os.path.join(base_path, '/Applications/GoogleAppEngineLauncher.app/Contents//Resources/GoogleAppEngine-default.bundle/Contents/Resources/google_appengine/')
